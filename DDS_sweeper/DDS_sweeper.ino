...
*  Date    : 2014-10-02                                                     *
*  Version : 1.1 DDS outputs remapped for Nano by VK3YY                     *
*                output format to PC changed for new PC analyser program    *
...
void Perform_sweep(){
  ...
  for(int i=0;i<=num_steps;i++){
    ...
    // Wait a little for settling (10ms)
    delay(10);
